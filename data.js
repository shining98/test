...
function calcXin() {
  ...
  baseXin[0] = (0.125 + gameData.passive[0]) * (1 + impSkill1 + heartEffect[0] + burstBonus[0]);
  baseXin[1] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[1] + burstBonus[1]);
  baseXin[2] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[2] + burstBonus[2]);
  baseXin[3] = (0.125 + gameData.passive[1]) * (1 + impSkill1 + heartEffect[3] + burstBonus[3]);
  baseXin[4] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[4] + burstBonus[4]);

  if (mode === "league") {
    baseXin[5] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[5] + burstBonus[5] - 0.714);
    baseXin[6] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[6] + burstBonus[6] - 0.714);
    baseXin[7] = (0.125 + gameData.passive[2]) * (1 + impSkill1 + heartEffect[7] + burstBonus[7] - 0.714);
  } else {
    baseXin[5] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[5] + burstBonus[5]);
    baseXin[6] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[6] + burstBonus[6]);
    baseXin[7] = (0.125 + gameData.passive[2]) * (1 + impSkill1 + heartEffect[7] + burstBonus[7]);
  }
