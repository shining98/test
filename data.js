...
var cardData = [
  ...
  { id:38, rarity:"闪耀", style:"甜美", designer:"溯烬", name:"天地一浮沤", skill:"部件得分⑧", collection:"裂帛惊梦", shadow:[0.61,0.71,0.8,0.9,0.98], passive:["裙","头","鞋"], styles:{典雅:255,清新:198,甜美:620,性感:198,帅气:255}, heartSkill:[0,0,0,0,0], shadowFlashMoment:[0,0,0,0,0], extraFlash:0 },
    { id:39, rarity:"闪耀", style:"甜美", designer:"长盈", name:"鉴照明月魄", skill:"部件得分⑦", collection:"命运交响", shadow:[0.58,0.68,0.77,0.87,0.93], passive:["裙","头","鞋"], styles:{典雅:200,清新:200,甜美:600,性感:248,帅气:248}, heartSkill:[0,0,0,0,0], shadowFlashMoment:[0,0,0,0,0], extraFlash:0 },
