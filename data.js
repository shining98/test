...
var cardData = [
  ...
  { id:39, rarity:"闪耀", style:"甜美", designer:"长盈", name:"鉴照明月魄", skill:"部件得分⑦", collection:"裂帛惊梦", shadow:[0.58,0.68,0.77,0.87,0.93], passive:["裙","头","鞋"], styles:{典雅:255,清新:198,甜美:600,性感:198,帅气:255}, heartSkill:[0,0,0,0,0], shadowFlashMoment:[0,0,0,0,0], extraFlash:0 },
...
function calcXin() {
  ...
  var leagueSum=0; for(var i=0;i<5;i++) leagueSum+=stdBaseXin[i];
