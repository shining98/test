...
var cardData = [
  ...
  { id:20, rarity:"闪耀", style:"清新", designer:"阿洛伊", name:"浮沉的画景", skill:"部件得分⑧", collection:"千羽森林", shadow:[0.61,0.71,0.8,0.9,0.98], passive:["裙","头","鞋"], styles:{典雅:208,清新:620,甜美:242,性感:242,帅气:208}, heartSkill:[0,0,0,0,0], shadowFlashMoment:[0,0,0,0,0], extraFlash:0 },
  { id:21, rarity:"闪耀", style:"清新", designer:"埃斯特拉", name:"玫瑰堙息地", skill:"部件得分⑦", collection:"镜中圆舞", shadow:[0.58,0.68,0.77,0.87,0.93], passive:["裙","头","鞋"], styles:{典雅:196,清新:600,甜美:255,性感:255,帅气:196}, heartSkill:[0,0,0,0,0], shadowFlashMoment:[0,0,0,0,0], extraFlash:0 },
  ...
  { id:23, rarity:"闪耀", style:"清新", designer:"微光", name:"黑猫与宇宙诗", skill:"部件得分⑥", collection:"镜中圆舞", shadow:[0.53,0.62,0.7,0.79,0.88], passive:["裙","头","鞋"], styles:{典雅:246,清新:580,甜美:206,性感:206,帅气:246}, heartSkill:[0,0,0,0,0], shadowFlashMoment:[0,0,0,0,0], extraFlash:0 },
  ...
  { id:37, rarity:"闪耀", style:"甜美", designer:"德拉薇尔", name:"龙与金色梦乡", skill:"部件得分⑧", collection:"镜中圆舞", shadow:[0.61,0.71,0.8,0.9,0.98], passive:["裙","头","鞋"], styles:{典雅:209,清新:209,甜美:620,性感:245,帅气:245}, heartSkill:[0,0,0,0,0], shadowFlashMoment:[0,0,0,0,0], extraFlash:0 },
  ...
  { id:67, rarity:"闪耀", style:"帅气", designer:"元怀音", name:"金册画中人", skill:"20s加分", collection:"裂帛惊梦", shadow:[0.18,0.21,0.24,0.27,0.3], passive:["裙","鞋","饰"], styles:{典雅:249,清新:249,甜美:201,性感:201,帅气:500}, heartSkill:[0.185,0.216,0.246,0.277,0.308], shadowFlashMoment:[0,0,0,0,0], extraFlash:0 },
  ...
  { id:75, rarity:"闪耀", style:"性感", designer:"银夕", name:"幻梦的潮声", skill:"闪瞬提升②", collection:"绮想夜", shadow:[0.16,0.18,0.21,0.23,0.26], passive:["裙","头","鞋"], styles:{典雅:246,清新:206,甜美:206,性感:540,帅气:246}, heartSkill:[0,0,0,0,0], shadowFlashMoment:[1.1,1.28,1.46,1.64,1.82], extraFlash:0 },
  ...
  { id:77, rarity:"闪耀", style:"性感", designer:"阿诺斯", name:"于海渊守望", skill:"部件得分③", collection:"千羽森林", shadow:[0.38,0.43,0.5,0.55,0.62], passive:["裙","鞋","饰"], styles:{典雅:246,清新:206,甜美:206,性感:520,帅气:246}, heartSkill:[0,0,0,0,0], shadowFlashMoment:[0,0,0,0,0], extraFlash:0 },
...
var reconstructData = [
  ...
  { id:34, rarity:"闪耀", attribute:"典雅", name:"诉尽离愁 / 游鳞逐波",           bonusType:"竞技光芒", baseScore:1195 },
...
function calcXin() {
  ...
  // 联盟最后一关：baseXin[5]~baseXin[7] 的乘数中减去0.714
  if (mode === "league") {
  ...
  // 统一写入 xin
  for (var i = 0; i < 8; i++) gameData.xin[i] = baseXin[i] + burstBonus[i];
  ...
  // 始终计算全部三个 xinSum
  // 标准 baseXin（无 -0.714、无爆发）
  var stdBaseXin = [0,0,0,0,0,0,0,0];
  stdBaseXin[0] = (0.125 + gameData.passive[0]) * (1 + impSkill1 + heartEffect[0]);
  stdBaseXin[1] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[1]);
  stdBaseXin[2] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[2]);
  stdBaseXin[3] = (0.125 + gameData.passive[1]) * (1 + impSkill1 + heartEffect[3]);
  stdBaseXin[4] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[4]);
  stdBaseXin[5] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[5]);
  stdBaseXin[6] = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[6]);
  stdBaseXin[7] = (0.125 + gameData.passive[2]) * (1 + impSkill1 + heartEffect[7]);

  // 联盟 baseXin
  var lgBaseXin5 = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[5] - 0.714);
  var lgBaseXin6 = (0.025 + gameData.passive[3]) * (1 + impSkill1 + heartEffect[6] - 0.714);
  var lgBaseXin7 = (0.125 + gameData.passive[2]) * (1 + impSkill1 + heartEffect[7] - 0.714);

  // arena xinSum[0]: 标准 xin + yzzh + sysj（无爆发、无 baofa）
  var arenaSum = 0;
  for (var i = 0; i < 5; i++) arenaSum += stdBaseXin[i] + burstBonus[i];
  arenaSum += stdBaseXin[5] + burstBonus[5] + stdBaseXin[6] + burstBonus[6] + stdBaseXin[7] + burstBonus[7];
  arenaSum += gameData.yzzh[0] + gameData.sysj[0];

  // heart xinSum[1]: arena + baofa
  var heartSum = arenaSum + gameData.baofa[0];

  // league xinSum[2]: 联盟 xin + yzzh + sysj（无 baofa）
  var leagueSum = 0;
  for (var i = 0; i < 5; i++) leagueSum += stdBaseXin[i] + burstBonus[i];
  leagueSum += lgBaseXin5 + burstBonus[5] + lgBaseXin6 + burstBonus[6] + lgBaseXin7 + burstBonus[7];
  ...
  for (var i = 0; i < 8; i++) {
    var el = document.getElementById("xin" + i);
    if (el) el.textContent = gameData.xin[i].toFixed(4);
  }
  ...
  // ============ Score数组（长度15） ============
  Score[0]  = DpScore[0] * 3 * (1 + gameData.yhjc[0]);
